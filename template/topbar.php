        ...
        <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li style="padding:0px">
                    <span class="m-r-sm text-muted welcome-message">Senin, 28 September 2020</span>
                </li>
                <li class="dropdown">
                ...
                <li class="border-left pl-3 pr-3">
                    <div class="profile-topbar dropdown">
                        <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="img/profile_small.jpg" draggable="false" class="img-sm rounded-circle" alt="">
