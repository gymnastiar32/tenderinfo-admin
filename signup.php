        ...
        <div class="col-md-6">
            <div class="ibox">
                <div class="ibox-title">
                    <h3 class="title">Membership Services</h3>
                ...
                <div class="ibox-content">
                    <p>
                        Berbagai bentuk layanan premium bagi Supplier / Kontraktor untuk membantu memasarkan produk dan layanannya kepada calon Pembeli akan dikembangkan oleh <a href="" class="text-primary"> Pengadaan.com</a>
                    </p>
                    <p>Untuk informasi lebih lanjut dapat menghubungi<a href="" class="text-primary"> cs@pengadaan.com</a></p>
                    <table class="mb-4">
                        <tr>
                            <td><i class="fa fa-phone mr-3"></i></td>
                            <td> Purwo Hendrianto <br>
                                (+)62 812-8165-3881 </td>
                        </tr>
                        <tr>
                            <td><i class="fa fa-envelope mr-3"></i></td>
                            <td>ipung@adw.co.id</td>
                        </tr>
                    </table>
                    <p>Wijaya Graha Puri, Blok H-33. Jl. Wijaya II Jakarta 12160 </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="ibox">
                ...
                <div class="ibox-content clearfix">
                    <form action="">
                        ...
                        <button class="btn btn-success b-r-md float-right">Sign Up</button>
                    </form>
                </div>
            </div>
        </div>
